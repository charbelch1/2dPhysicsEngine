       ...
       public void ResolveCollisionWithRotation(in FlatManifold contact )
        {
            ...
            for (int i=0; i < contactCount; i++)
            {
                ...
                FlatVector relativeVelocity =
                    (bodyB.linearVelocity+ angularLinearVelocityB) - (bodyA.linearVelocity + angularLinearVelocityA);
                ...
                float denom = bodyA.InvMass + bodyB.InvMass + (raPerpDotN * raPerpDotN) * bodyA.InvInertia + (rbPerpDotN * rbPerpDotN) * bodyB.InvInertia;
        ...
        public void ResolveCollisionWithRotationAndFriction(in FlatManifold contact)
        {
            ...
            for (int i = 0; i < contactCount; i++)
            {
                ...
                float denom = bodyA.InvMass + bodyB.InvMass + (raPerpDotT * raPerpDotT) * bodyA.InvInertia + (rbPerpDotT * rbPerpDotT) * bodyB.InvInertia;
